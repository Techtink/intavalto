  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setProfile(data);
        setEditData({ displayName: data.displayName || '', bio: data.bio || '', location: data.location || '' });
      } catch (err) {
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input type="text" value={editData.location}
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" placeholder="City, Country" />
                </div>
              </div>
