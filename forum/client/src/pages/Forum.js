          ...
          <div className="py-3 px-2">
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                ...
                {exploreOpen && (
                  <div className="absolute left-0 bottom-full mb-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg z-30 px-3 py-2 flex items-center gap-1.5">
