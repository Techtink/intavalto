...
export default function About() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [aboutRes, catRes, prodRes, logoRes, bannerRes, socialRes] = await Promise.all([
          api.get('/settings/about'),
          api.get('/categories').catch(() => ({ data: [] })),
          api.get('/products').catch(() => ({ data: [] })),
          api.get('/settings/logo').catch(() => ({ data: {} })),
          api.get('/settings/banner').catch(() => ({ data: {} })),
          api.get('/settings/social').catch(() => ({ data: {} })),
        ]);
              ...
              <div className="relative">
                ...
                {exploreOpen && (
                  <div className="absolute left-0 top-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg z-30 px-3 py-2 flex items-center gap-3">
                    {socialLinks.socialFacebook && <a href={socialLinks.socialFacebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="Facebook">
                      <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>}
                    {socialLinks.socialX && <a href={socialLinks.socialX} target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="X">
                    ...
                    {socialLinks.socialInstagram && <a href={socialLinks.socialInstagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="Instagram">
                    ...
                    {socialLinks.socialYoutube && <a href={socialLinks.socialYoutube} target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="YouTube">
                    ...
                    {socialLinks.socialTiktok && <a href={socialLinks.socialTiktok} target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" title="TikTok">
