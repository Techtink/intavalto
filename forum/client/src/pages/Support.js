        ...
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <Link to="/login" className="bg-blue-600 text-white px-4 py-1.5 rounded text-sm font-medium hover:bg-blue-700">{t('common.logIn')}</Link>
            )}
            <LanguageSelector />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 mb-8 text-center transition-colors">
          ...
          {user ? (
            ...
            <div>
              ...
              <Link to="/login" className="bg-blue-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 inline-block">
              ...
              <div className="space-y-3">
                {tickets.map(ticket => (
                  <Link key={ticket.id} to={`/support/${ticket.id}`}
                    className="block bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-sm transition-all">
